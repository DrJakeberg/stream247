...
export default async function SourcesPage() {
  ...
  return (
    <div className="stack-form">
      <AdminPageHeader
        description="Library is the media workspace for connectors, uploads, pools, and the playable catalog. Use it to prepare future output rather than trigger live actions."
        eyebrow="Library"
        title="Manage sources, uploads, pools, and the playable catalog."
      />

      <div className="grid two">
        <Panel title="Add source" eyebrow="Connectors">
          <p className="subtle">
            Start from a source template instead of raw connector fields. Direct media URLs, full YouTube playlists or
            channels, Twitch VODs or archive channels, and the local media library are all ingestible now.
            Channel-based connectors preserve source metadata like original title and natural duration.
          </p>
          <SourceCreateForm />
        </Panel>
        ...
        <Panel title="Source connectors" eyebrow="Library">
          <p className="subtle">
            Sources now act more like a programming library, not just connector rows. Edit naming, connector type,
            source URL, and enabled state directly here, then review how many assets each source currently contributes
            to your pools.
          </p>
