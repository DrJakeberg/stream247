...
SPEC="${DESIGN_BASELINE_SPEC:-tests/e2e/design-baseline.spec.ts tests/e2e/layout-stability.spec.ts tests/e2e/wording-baseline.spec.ts tests/e2e/control-density.spec.ts tests/e2e/scene-preset-interaction.spec.ts tests/e2e/engagement-settings-interaction.spec.ts tests/e2e/link-targets.spec.ts}"
